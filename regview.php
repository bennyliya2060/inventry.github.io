...
<!-- !PAGE CONTENT! -->
  ...
  <td><a href="view.php?viewid=<?php echo $row[0];?>"><img src="view.jpg"></a></td>
  <td><a href="update.php?updateid=<?php echo $row[0]; ?>"><img src="update.jpg"></a></td>
  <td><a href="delete.php?deleteid=<?php echo $row[0];?>"><img src="delete.jpg"></td>
  </tr>
<?php
  }
?>
