...
<!-- !PAGE CONTENT! -->
  ...
  <div class="w3-hide-large" style="margin-top:83px"></div>
        ...
        <form class="form-row align-items-center" Align="center" action="productaction.php" method="POST">
        <?php
        ...
        ?>
           ...
           <td Align="center">
           <br>
           pname: <input type="text"  name="pname" value="<?php echo $row[1]; ?>"readonly> 
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           Type:<input type="text" name="type" value="<?php echo $row[2]; ?>"readonly>
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           brand: <input type="text" name="brand" value="<?php echo $row[3]; ?>" readonly>
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           quantity: <input type="text" name="quantity" value="<?php echo $row[4]; ?>" readonly>
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           price: <input type="text" name="price" value="<?php echo $row[5]; ?>"readonly> 
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           expdate: <input type="date" name="exp" value="<?php echo $row[6]; ?>" readonly>
           <br>
           <br>
           <br>
           </td>
