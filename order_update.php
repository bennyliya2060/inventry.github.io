...
<!-- !PAGE CONTENT! -->
  ...
  <div class="w3-hide-large" style="margin-top:83px"></div>
        ...
        $sql="SELECT * FROM  order_form WHERE id=$update";
        // echo $sql;
        // exit;
        ...
        <br>
           ...
           <tr Align="left">
           <td Align="center">
           address: <input type="text" name="address" value="<?php echo $row[2];?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           phno: <input type="number" name="phno" value="<?php echo $row[3];?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <td Align="center">
           <br>
           pname: <input type="text"  name="pname" value="<?php echo $row[5];?>"> 
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           Type:<input type="text" name="type" value="<?php echo $row[6]; ?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           brand: <input type="text" name="brand" value="<?php echo $row[7]; ?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           quantity: <input type="text" name="quantity" value="<?php echo $row[8]; ?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           price: <input type="text" name="price" value="<?php echo $row[9]; ?>"> 
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           status: <input type="text" name="status" value="<?php echo $row[10]; ?>"> 
           <br>
           <br>
           <br>
           </td>
