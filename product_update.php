...
<!-- !PAGE CONTENT! -->
  ...
  <div class="w3-hide-large" style="margin-top:83px"></div>
        ...
        ?>
        <table class="form-row align-items-center" Align="center" width="30%" height="40%">
        <form Align="center" action="product_update_action.php?updateid=<?php echo $row[0];?>" method="POST">
           <br>
           <br>
           <tr Align="left">
           <td Align="center">
           ...
           <tr Align="left">
           <td Align="center">
           expdate: <input type="date" name="exp" value="<?php echo $row[6]; ?>">
           <br>
           <br>
           <br>
           </td>
