...
<!-- !PAGE CONTENT! -->
  ...
  <div class="w3-hide-large" style="margin-top:83px"></div>
        ...
        $sql="SELECT * FROM  staff_register  WHERE id='$update'";
        // echo $sql;
        // exit;
        ...
        <form Align="center" action="uptaction.php?updateid=<?php echo $row[0];?>" method="POST">
           <br>
           <br>
           <tr Align="left">
           <td Align="center">
           ...
           <tr Align="left">
           <td Align="center">
           phno: <input type="number" name="phno" value="<?php echo $row[4]; ?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           username: <input type="text" name="usr" value="<?php echo $row[5]; ?>">
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           password: <input type="password" name="pwd" value="<?php echo $row[6]; ?>"> 
           <br>
           <br>
           <br>
           </td>
           ...
           <tr Align="left">
           <td Align="center">
           email: <input type="text" name="email" value="<?php echo $row[7]; ?>">
           <br>
           <br>
           <br>
           </td>
